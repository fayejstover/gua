...
const _saved = JSON.parse(localStorage.getItem('gua-selections') || 'null');
const selected = _saved || { ...DEFAULTS };
...
function chooseHotel(night, id) {
  selected[night] = id;
  localStorage.setItem('gua-selections', JSON.stringify(selected));
